...
MODULE control_kcw
  ...
  INTEGER,  ALLOCATABLE   :: igk_k_all(:,:)             ! index of G corresponding to a given index of k+G, ALL k
  INTEGER,  ALLOCATABLE   :: ngk_all(:)                 ! number of plane waves for each k point, ALL k
