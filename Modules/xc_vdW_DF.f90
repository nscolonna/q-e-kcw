...
CONTAINS
  ...
  !                        |________________|
  !
  ! The following two Perdew-Wang correlation routines are direct copies
  ! from XClib/qe_funct_corr_lda_lsda.f90. With earlier restructuring
  ! efforts (commit 6c5404ffcd7f53079e568f4d62eadcb47775c03b) there was
  ! a need to avoid low-level calls of XClib routines such that their
  ! corresponding source code was placed right here. However, we are
  ! working to remove this requirement and call the original rountines
  ! again, allowing us to remove their temporary copies here.
