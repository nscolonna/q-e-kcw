...
! A.D. and TYK (03/03/2026): We have added symmetrization of the matrix
! elements (dipole_symmetrize) and the addition of the nonlocal 
! pseudopotential contribution in eps_calc/dipole_calc2. 
...
!        ENDIF
        ...
        ! approximation.
        ! 'intersmear' is the broadening parameter
        !
        ! Interband
        !
